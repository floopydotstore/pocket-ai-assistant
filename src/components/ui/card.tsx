...
>(({ className, variant = 'default', ...props }, ref) => {
  const variants = {
    ...
    interactive: "rounded-xl border bg-card text-card-foreground shadow-card hover:shadow-elevated hover:border-primary/20 transition-all duration-200 cursor-pointer active:scale-[0.99]",
  };
